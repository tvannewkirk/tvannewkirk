...
<br /><br />
I also completed the Cisco Certified Network Associate Certification which validated my skills in IP routing and IP connectivity, network security fundamentals and access control, VLANs and trunking and many more topics. I enjoyed the opportunity to work directly with Cisco equipment such as a 2960 switch and to learn the technologies through hands-on projects and labs. This certification provides a strong foundation for those who want to expand their knowledge and experience into the field of networking. I look forward to the challenge of completing the Cisco Certified Network Professional Enterprise Core Exam following my previous exam. I expect to complete this portion of the Cisco Certified Network Professional certification by April 2026.
<br />

<h2>👨‍💻 Information Technology Projects:</h2>

- [Active Directory Virtual Machines Project](https://github.com/tvannewkirk/ActiveDirectoryLab)
- [osTicket Ticketing System Implementation (in progress)](https://github.com/tvannewkirk/OSTicket-Ticketing-System)
